...
See libraries.tex: wpobjectives and wpdescription

\subsection*{Libraries}

The different tasks of this WP are identical with the above libraries

\subsubsection*{T1: MathComp}

GT

\subsubsection*{T2: Revised Coq Analysis library}

GT? SB?

\subsubsection*{T3: Isabelle's Archive of Formal Proofs}

See libraries.tex

\subsubsection*{T4: The Isabelle Analysis & Probability library}

See libraries.tex

\subsubsection*{T5: The GeoCoq library}

See libraries.tex

\subsection*{Challenges}

Are documented in each task. The key challenges are scalability and accessibility.
...
\subsection*{Relation to other WPs}
