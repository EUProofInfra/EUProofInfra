...
\item Frédéric Blanqui leads the \WPref{dissemination}. He is a member of the
  ...
  (ISR).
\item Stephan Merz leads the \WPref{theories} and task \taskref{theories}{tla}.
  He is one of the designers and developers of the \tlaplus Proof System.
\item Enrico Tassi participates to \taskref{instrument}{coq} and WP7.T5 (Alignment based proof rewriting). He is a core
...
\item{\bf Stephan Merz} (leader of work package \WPref{theories}) is a senior research
