...
\begin{compactitem}
\item ``Dedukti: a logical framework based on the $\lambda\Pi$-calculus modulo theory'', by A. Assaf and G. Burel and R. Cauderlier and D. Delahaye and G. Dowek and C. Dubois and F. Gilbert and P. Halmagrand and O. Hermant and R. Saillard, journal submission, 2019.
\item ``A semantic framework for proof evidence'', by Zakaria Chihani, Dale
...
\begin{compactitem}
\item ERC Advanced Grant titled “ProofCert: Broad Spectrum Proof
...
on Logic in Computer Science (LICS) and has served as a programme committee chair
