...
\item Since 2006 Inria has supported the development of the Mathematical Components
  ...
  the Odd Order Theorem, since 2012 the library is publicly distributed
...
His research interests range from interactive programme verification and mechanised
...
for user-guided interactive source-to-source optimisations, with formal correctness
guarantees.
He co-organises and designs tasks for the french version of the Bebras Contest,
attended each year by 700.000+ pupils aged 8 to 18.
%He also co-organised the Summer School for Young Reseachers (EJCP) in Strasbourg in 2019.
...
research centre. He has been active in several types of
...
His work addresses the formalisation of mathematics, the proof
...
of proof assistant features targeting mathematics the way
...
His research interests are centred on the   correct-by-construction
...
His research interests are centred on the formal specification and verification
...
centre in Sophia-Antipolis. He obtained his PhD (2008) at the University of
...
international conferences such as ITP, CPP, PADL, MKM. He regularly organises
