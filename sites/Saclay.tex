...
\begin{itemize}
\item Interoperability between ATPs and Logipedia: \WPref{atpetc}, tasks
  \taskref{atpetc}{tracetodedukti}, \taskref{atpetc}{deduktitoatp} and
  \taskref{atpetc}{readiness}
\item Extending Dedukti with metadata, and generating them:
  \WPref{structuring}, tasks \taskref{structuring}{strlibstructure},
  \taskref{structuring}{strdofimpl}, \taskref{structuring}{strrefonto} and
  \taskref{structuring}{strontorepml}
\item UNDER PROGRESS: \WPref{theories}
\item Automatic proofs of concept alignment: \WPref{alignment}, task
  \taskref{alignment}{aligntheories}
\end{itemize}
...
\item {\bf Burkhart Wolff} is full professor at Université
  ...
  knowledge. He is one of the two coordinators of \WPref{structuring}.
