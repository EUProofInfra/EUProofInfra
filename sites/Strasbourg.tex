...
\begin{compactitem}
\item Integration of the GeoCoq library in Logipedia: \WPref{libraries}, task \taskref{libraries}{geocoq}. As maintainers of the GeoCoq library, the group can adapt the library for easier integration into Logipedia.
\item Concept alignment for geometry: \WPref{alignment}, task \taskref{alignment}{aligncasestudies}. 
