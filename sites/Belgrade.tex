\begin{sitedescription}{Bel}
  ...
  reasoning in geometry, software verfication and other applications
  of automated and interactive theorem proving. This research group is
  internationally visible and well recognized: over the last 10 years
  ...
  20 countries, and organized a number of seminars and international
  ...
  \item Filip Marić and Danijela Simić participate at
    ...
    Isabelle/HOL.
  \item Sana Stojanović Đurđević participates in \WPref{alignment},
    task \taskref{alignment}{aligncasestudies}. She is a coauthor of
    an automated theorem prover for coherent logic, and the coautor of
    several interactive and automated formalizations of Euclidean
    geometry.
  \end{compactitem}
