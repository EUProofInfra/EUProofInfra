\begin{sitedescription}{Bel}
  ...
  \item Filip Marić and Danijela Simić participate at
    ...
    Isabelle/HOL.
  \item Sana Stojanović Đurđević participates in \WPref{atpetc}, task
    \taskref{atpetc}{deduktitoatp} and \WPref{alignment}, task
    \taskref{alignment}{aligncasestudies}. She is a coauthor of an
    automated theorem prover for coherent logic, a coauthor of
    vernacular for coherent logic, and author of semi-formal proof
    format for coherent logic. She is coautor of several interactive
    and automated formalizations of Euclidean geometry.
  \end{compactitem}
