...
\begin{compactitem}
\item ``Recovering High-Level Conditions from Binary Programs'', by Adel Djoudi, Sébastien Bardin, Éric Goubault, 21st International Symposium on Formal Methods (FM 2016), November 2016, Limassol, Cyprus
\item ``Making Agile Development Processes fit for V-style Certification Procedures'', by Sergio Bezzecchi, Paolo Crisafulli, Charlotte Pichot, Burkhart Wolff, 9th European Congress on Embedded Real Time Software and Systems (ERTS 2018), Jan 2018, Toulouse, France
\end{compactitem}
