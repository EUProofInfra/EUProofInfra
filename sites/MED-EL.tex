...
\ednote{logo + web site + a description of the legal entity}
...
\begin{compactitem}
\item Case study of the application of formal verification in the industrial setting
  in \WPtref{theories}.
%Application of formal verification methods in the industrial settings.
\end{compactitem}
