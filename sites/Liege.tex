...
\begin{compactitem}
\item \WPref{atpetc}, task \taskref{atpetc}{instrumenting}: Instrumenting ATPs to produce traces, FOL provers and SMT (Boigelot, Fontaine, PhD student)
\item  \WPref{atpetc}, task \taskref{atpetc}{tracetodedukti}: Translate ATP traces into Dedukti, FOL provers and SMT (Fontaine, PhD student)
\item \WPref{atpetc}, task \taskref{atpetc}{deduktitoatp}: Translate Dedukti statements into ATPs inputs, TPTP and SMT-LIB (Fontaine, PhD student)
\end{compactitem}
...
\item{\bf Pr. Dr. Pascal Fontaine} (male, co-leader of work package \WPref{atpetc}) is a
