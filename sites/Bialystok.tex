...
\item\textbf{Dr.\ Artur Korniłowicz} (male) is the deputy director for science 
...
\item\textbf{Dr.\ Czesław Byliński} (male) is head of the Computer Networks Section at the University of Bialystok.
...
\item\textbf{Dr.\ Adam Grabowski} (male) is an adjunct at UwB since 2006, 
...
\item\textbf{Dr.\ Adam Naumowicz} (male) is a~member of the core Mizar development team. 
...
\item\textbf{Dr.\ Karol Pąk} (male) has developed the Isabelle/Mizar system where
