...
\begin{compactitem}
\item \taskref{instrumentation}{atelier-b} Instrument Atelier-B/Rodin. Design an import/export to/from Dedukti of Event-B machines, proof obligations and proofs.  Experiments will be defined for validation purposes. The team has a long experience in meta-level reasoning within proof assistants, formal model transformation and verification.

\item \taskref{structuring}{strrefonto} Reference ontology. Import/export to/from Dedukti of specific domain theories encoding knowledge domains in system engineering with a specific focus on transportation systems. Part of the team as a long experience in formal modelling based on ontologies and event-based modelling languages.
\end{compactitem}
