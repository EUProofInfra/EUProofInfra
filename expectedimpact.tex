...
fortunately been growing with time, but that is still not fast enough,
...
for companies that have a strong formal proof activity (CEA
LIST, Clearsy, Edukera, MED-EL, OCamlPro, Prove\&Run, IRT SystemX,
and Runtime verification) are full partners of the project, will
contribute to its work packages and tasks and co-build the
infrastructure with the other partners.
\\
&
\hspace{0.4cm}
