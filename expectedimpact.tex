...
indexing mechanisms for mathematical formulas, and search engines
  that are specialised to query such formulas,
\\
&
$\blacktriangleright$
...
$\blacktriangleright$
  ergonomic user interfaces, that allows a navigation in the
    structure of the encyclopedia, and that can be specialised for
...
&
\hspace{0.4cm}
An effort will be made to familiarise new researchers and engineers,
...
recent controversy on the $abc$ conjecture),
  mathematicians will be able to formalise it faster and at a lower
...
of the minimal means to prove a theorem) will be able to analyse, in
...
$\blacktriangleright$ As mathematics and software are ubiquitous in 
  ...
  a car or piloting an aircraft require to formalise part of the physical 
...
sub-community being centred around its own system, its own theory,
and its own library or libraries.\\
&
\hspace{0.4cm}
To build a stronger community, where the researchers develop
strategies, it is not sufficient to talk to each other, or to organise
...
community (that already meets around the OpenTheory standard),
...
&
\hspace{0.4cm} We have already organised two Logipedia workshops in
...
\colorbox{color2}{\bf Performance indicators:}
\begin{compactitem}
\item 20 \% of proofs developed in one system can used in another at month 24
  and 40 \% of proofs developed in one system can used in another at month 48.
\item Number of interactive proof systems generating a verifiable certificate
is larger than 8 at month 24 and 12 at month 48.
\item Number of automatic theorem provers generating a verifiable certificate
is larger than 4 at month 24 and 6 at month 48. 
...
formalisation across communities.
\\
...
$\blacktriangleright$
2.
{\bf Paving the way towards standardisation.}
...
standardisation process to be still premature, this project will allow us
...
Second, we will build over the project duration time a {\em club of
  industrial users}. This club already has 18 members.
Their letters of intent are at the end of the document for (Section 6).
\\
&
\hspace{0.4cm}
...
The club will organise a meeting every year where the
...
&
\hspace{0.4cm} From the point of view of its members, this club is a
unique opportunity for watching the current state of technology. Our
empirical observations show that many enterprises, working in
safety-critical areas, would like to be more involved in the
development of formal methods, but that the first step into using such
methods is often too costly. This club will offer them a smoother way
to get into this technology. Such a club where the industrial users
will develop a common culture in formal methods, share experience with
other enterprises, and conduct technology watch on a regular basis is
an efficient way to disseminate formal methods in the European
industry.\\ &
\hspace{0.4cm}
...
traditional software. Software, in the field of health care, should
...
functionalities without unexpected behaviours. In particular, the
...
certification process in the energy industry depends a lot on a
given country. Indeed, they do not share common certification
practices, unlike in the aeronautic industry. So an enterprise who
...
tools. The tools recognised by one certification authority are
...
because the blockchain technology and its applications evolve quickly,
...
these specialised proof systems. Answering this question of
...
generation of researchers, through theses and post-doc contracts.\\
&
...
of formalised results.  By collecting the results already available in
...
lack of a large and well organised library of results.  Logipedia,
...
textbooks that promote mathematical rigour by including only
...
\colorbox{color2}{\bf Performance indicators:}
\begin{compactitem}
\item Twelve students start a PhD during the project.
\item Two summer schools are organised during the course of the project.
\item The number of members of the club of users in education
  grows by 20\% every year.
\item Each member of the club of users in education organised a
...
Karve Vaibhav (University of Illinois),
...
quest for higher level of rigour will pave the way for a development
...
instance, scientists willing to formalise hybrid systems should have
...
flow of data is at the centre of the Logipedia project. We already
...
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline {\bf Integrated and harmonised access to resources facilitating evidence-based policy making} & Some certification authorities such
...
\colorbox{color2}{\bf Performance indicators:}
\begin{compactitem}
\item At least two meetings have been organised with 
...
\colorbox{color2}{\bf Performance indicators:}
\begin{compactitem}
\item An open workshop is organised to raise the awareness of ethics
  committees on the importance of formal proofs for safety, security,
  and ethics.
\end{compactitem}
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
{\bf Open data, Open science, and Open innovation}
&
Logipedia is clearly part of the Open data, Open science, and Open
...
\colorbox{color2}{\bf Performance indicators:}
\begin{compactitem}
\item The platform Logipedia is functional, allowing open access to all the proofs it contains.
\end{compactitem}
\\
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\hline
...
publication process, there is a lack of discipline to emphasise the
...
\hspace{0.4cm}
Logipedia will provide services to the community of
mathematicians and to the community of scientific publishers. Il will
provide hyperlinks to Logipedia proof objects, authors can focus on
the presentation of their results and help reviewers and editors in
evaluating their correctness and interest. Readers can be
...
can also visualise the axioms and theorems they rely on.
...
\colorbox{color2}{\bf Performance indicators:}
\begin{compactitem}
\item The club of users in publishing develops and includes one
  representative of each major publishing venue.
