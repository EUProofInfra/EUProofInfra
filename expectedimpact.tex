...
\begin{minipage}{3cm}
New or more advanced research infrastructure
\end{minipage}
&
\begin{minipage}{3cm}
...
\subsubsection*{Operators develop synergies}
...
\subsubsection*{Innovation is fostered through a reinforced partnership of
...
\subsubsection*{Closer interaction between a larger number of researchers}
...
\subsubsection*{Better management of the continuous flow of data}
...
\subsubsection*{Socio-economic impact}
...
\subsubsection*{Open data / Open science / Open innovation}
...
\subsection{Key Exploitable results}
