...
proofs in Coq, in Matita, in HOL Light, in 
...
We have already organized two Logipedia meetings that have
...
project will develop a {\em club of industrial users of Logipedia}.
...
for instance, contribute to the production of Logipedia proofs
from B provers.

{\color{red} Club of industrial users (Frédéric, can 
you explain the impact here?)}

{\color{red} Impact for the B community and the railway industry
  (Yamine?)}
...
- Block chain ({\color{red} Raphaël writes this}), smart contract : small programme, lots of money. Touches different areas (cooperation of specialized tools)
