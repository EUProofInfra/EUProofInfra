...
\begin{proposal}[%
  ...
  \vspace*{5mm}
  \begin{center}
    {\Large\bf The club of industrial users\footnote{The letters of intent are at the end of the document for sections 4-5.}:}
  \end{center}
...
\chapter{Letters of intent of the members of the club of industrial users}
