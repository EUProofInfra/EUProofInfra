...
\begin{document}
{\color{red} version du 9 mars à 12:38}% modified by Frédéric only
...
\begin{proposal}[%
  ...
  \pagestyle{empty}
  \newcommand\ap{{\color{Green3}$\bullet$}}% academic partner
  \newcommand\ip{{\color{DarkOrange2}$\bullet$}}% industrial partner
  ...
  \newcommand\logo[1]{\includegraphics[width=28mm]{logos/#1}}
