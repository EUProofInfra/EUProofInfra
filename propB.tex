...
\begin{proposal}[%
  ...
  {\bf Club of industrial users:} % in alphabetical order
  \vspace*{3mm}
  
  \begin{tabular}{ccccc}
    Alstom & \logo{CEAList} & \logo{ClearSy} & \logo{Edukera} & \logo{Facebook}\\[8mm]
    \logo{IBM} & \logo{MED-EL} & \logo{MERCE} & \logo{NomadicLabs} & \logo{OCamlPro}\\[8mm]
    \logo{OriginLabs} & \logo{ProveRun} & TrustInSoft & RATP & \logo{SystemX}\\[8mm]
    \logo{Systerel}\\
  \end{tabular}
  ...
  {\color{red} to do: use ``in kind'' when appropriate

  Be more precise on licences, in particular when proofs already have a licence

  Draft a list of milestones}
