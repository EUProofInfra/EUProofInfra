...
and security in European industry. This club is also only in its
initial phases, but we are confident that the initial members of this
club will be followed by many others during the course of the project.\\
&
\hspace{0.4cm}
...
&
\hspace{0.4cm}
Third, we will also to develop a similar culture of technology watch
...
why we have organized a third ``club of users in education''.  Here we
do not advocate teaching formal proofs to pre-schoolers (we should not
repeat the mistakes of the past). However, we aim to foster a culture
of rigor in high-school mathematical thinking, by having rigorous
statements of theorems in high-school textbooks (including all the
corner cases that are often omitted), as well as a clear structure of
how each proof of a theorem relies on other theorems. This improved
rigor is useful for both the students who will take science at
University and to those who will not. In particular, in this way we
want to contribute modestly to the renewal of the culture of logical
thinking, which is of prime importance in our ``post-truth era''.\\
&
\hspace{0.4cm}
