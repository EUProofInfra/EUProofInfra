...
The development and maintenance of {\textsf Logipedia} will eventually lead
to the discussion of standards for proof languages, even if such an
effort is premature today.

A yearly workshop of {\textsf Logipedia} developers and users will be
...
The licence chosen for the proofs in {\textsf Logipedia} and its interface
...
Second, as any infrastructure, {\textsf Logipedia} raises new research
