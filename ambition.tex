...
The licence chosen for the proofs in Logipedia and its
interfaces will allow a free access, a findable, accessible,
interoperable, and reusable (FAIR) data management. It will contribute to 
the development of the open data / open science philosophy.
...
each proofs and algorithms, such as constructivization algorithms, to
translate proofs from one theory to another.

So, while the Qed manifesto was premature, now is the right time to
