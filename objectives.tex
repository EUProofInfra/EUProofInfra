...
{\color{red} Remove or at least rephrase the next paragraph}
...
\hline
{\bf LIL 2:} & The system has been instrumented so that some of its proofs
can be exported and checked in Dedukti.\\
\hline
{\bf LIL 3:} & 20 \% of the library of the system has been
exported and checked in Dedukti.\\
\hline
{\bf LIL 4:} & A significant part of the library of the system has
...
ProvenTools, TLA+, and Why3, as well as two formats used in
...
constitute an excellent benchmark for the methods developed, and they
...
&
Bringing 20\% of the library to LIL 5, that is making
