...
RV is a research and development start-up advocating for the industrial
...
RV promotes a "one semantics to rule them all" phylosophy; that is, the usage
...
conditions.
Logipedia will foster the innovation potential of RV in several directions:\\

&
$\blacktriangleright$
As part of RV's involvement in the Logipedia project, the infrastructure of 
RV's ML prover will be adapted to allow the generation of proof traces which
