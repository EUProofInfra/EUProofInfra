...
81\% of the budget funds the seven scientific and technological work
pacakges (17\% for WP1, 13\% for WP2, 8\% for WP3, 8\% for WP4, 8\%
for WP5, 16\% for WP6, and 10\% for WP7), 11\% is for the work package
``Dissemination, communication, and exploitation'', and 8\% for the
...
made to Strasbourg.  The total budget for missions allocted to
...
\hline
  ...
  Travel \& subsistence for trans-national access (if applicable) & & \\
  \hline
  Other travel & 12150 & Visits (TODO) \\
  \hline
  Equipment & & \\
  \hline
  Other goods and services & & \\
