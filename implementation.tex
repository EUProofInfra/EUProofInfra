...
As explained in Section~\ref{sec:subcontracting}, \site{Fau} asks for 20,000 Euro, which will be used to subcontract M. Wenzel to carry out a part of the work in Task \taskref{structuring}{strontorepml}.\ednote{Rabe@Dowek: This is part of the WP7 budget. But it is not included in the PMs in WP7 because money for subcontracts must be declared in a different column in the official EU tables. Instead, it is listed here.}
