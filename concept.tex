...
\begin{tabular}{ll}
\begin{minipage}{14cm}
\href{http://isabelle.in.tum.de/}{Isabelle/HOL} is an implementation of Simple Type Theory in the
...
\begin{minipage}{14cm}
\paragraph*{\tlaplus.}
\tlaplus~\cite{lamport:specifying} is a specification language based
on Zermelo-Fraenkel set theory and the Temporal Logic of Actions, a
dialect of linear-time temporal logic. It is intended for the precise
description of discrete systems and in particular of distributed
algorithms and systems.  \tlaplus has been substantially adopted by
enterprises working on distributed and cloud systems,
e.g.~\cite{newcombe:amazon-cacm}. The two main software tools for
...
whereas Mizar and TLA$^+$ are based on classical set theories. All
...
\subsubsection*{Other projects (non directly funded by the European Union)}
