...
contrast to usinga tactic language to generate proof terms). To support the
...
\item Some steps in the proof traces are not provable: their
  ...
  proof. This is the case for instance of the Skolemization step performed by an
