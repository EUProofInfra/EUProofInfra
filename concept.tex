...
\begin{tabular}{ll}
\begin{minipage}{14cm}
{\bf\href{http://lamport.azurewebsites.net/tla/tla.html}\tlaplus}
...
companies working on distributed and cloud systems\cite{newcombe:amazon-cacm}. The two main software tools for
