...
There is also a strong relationship with \WPref{atpetc} because several of the
systems considered in \WPref{theories} (Mizar, PVS, and TLAPS) call on automatic
back-end provers and require instrumentation similar to the proof engines
considered in \WPref{atpetc} so that proofs can be exported to Dedukti.
