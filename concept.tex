...
\subparagraph*{Instrumenting automatic theorem provers to produce proof traces.}
...
SMT solvers (Alt-ergo, CVC4, VeriT) and two provers for predicate logic
(the E-prover, Zipperposition).  We
...
\subparagraph*{Translate automatic theorem provers traces into Dedukti.}
...
\subparagraph*{Translate Dedukti statements into automatic theorem provers
  inputs.}
...
\subparagraph*{Logipedia as a source of knowledge for automatic theorem provers.}
...
\subparagraph*{Automatic theorem provers for Dedukti.}
...
\subparagraph*{Automation for Logipedia.}
...
\subsubsection*{Success measures for ATPs}
...
proof checking will measure the success of combining ATPs with Logipedia.
...
proofs. The participation of Pascal Fontaine to both project is also a
...
Nicolas Thierry which ran from 2015 to 2019 that has built a the joint
ecosystems of software for mathematics.
\\
&
\hspace{0.4cm}
OpenDreamKit and Logipedia's goal are related but different as OpenDreamKit
targets software for mathematics and Logipedia formal proofs. But both type 
of objects are used to mathematicians, computer scientists, scientists in 
...
share with ProofPeer that works with Matita, Mizar, Coq, and for any
