...
such systems: Mizar, TLA$^+$, PVS, Minlog, Why3, Smart, and Matching
logic in order to understand how to express their theory in Dedukti.
We also consider Homotopy type theory that is a theory, but not a
system.
...
{\color{red} Destroyed by a git mistake ?}
