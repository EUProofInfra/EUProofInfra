...
{\color{red} Could not we use the sames examples as above?}
...
by \site{Fau} in the {\em OpenDreamKit} project \cite{ODK:mitm:18}, we
...
Hilbert’s, or Tarski’s axioms or analytically using coordinate systems
and algebra.  Therefore, our first step will be to import into Dedukti
the equivalence theorems between these different axiomatizations. In
