...
\subsubsection{Description of the work package \WPref{theories}}
...
\subsubsection{Source Level Structure and Metadata}
...
The latter is a particularly interesting option for very large proofs (such as the ones considered in \WPref{atpetc}), where complete encodings of kernel objects may easily run out of memory.
...
However, these source representations will be much harder to generate in practical encodings.
...
This method works particularly well in connection with the alignments developed in \WPref{alignment}:
...
The data structures developed in this work package will be used critically in Task~\tasktref{access}{search}.
...
%%%%% end description of the work package 7 
