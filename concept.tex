...
logical truth had been challenged in a similar way, by the
...
compiler to an intermediate representation in predicate logic using
...
constructive Simple type theory themselves, can be defined
...
challenges are support for co-induction and co-recursion, which are not available
...
are support for co-induction and co-recursion. We plan to export program
