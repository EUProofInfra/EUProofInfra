...
their theories: those of Mizar, TLA$^+$, PVS, Minlog, Why3, ProvenTools, and
...
% ProvenTools is based on a classical first-order logic with rank-1
% polymorphism, algebraic data types, recursive definitions, and inductive
% predicates.
% Proof obligations generated from ProvenTools models are presented as virtual
