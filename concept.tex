...
Dedukti.  Then, we must instrument the system $X$ so that a proof in system $X$
...
Atelier B and Rodin are platforms to develop models written
...
both versions of the B method is based on formal proofs: proof obligations are
...
whether they are called first-order automatic theorem provers, SAT solvers, SMT
