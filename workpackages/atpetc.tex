...
\ednote{MK: interested parties (add their sites and RM here): Guillaume Burel, David Deharbe, Pascal Fontaine, Emilio J. Gallego Arias, Thibault Gauthier, Olivier Hermant, Cezary Kaliszyk, Chantal Keller, Filip Marić, Stephan Merz, Dale Miller, Julien Narboux, Martin Suda, Josef Urban}
...
\begin{tasklist}
  ...
  \begin{task}[id=commang,title=Cooperation of Reasoners via Dedukti/Logipedia]
    ...
    %% Pascal Fontaine: SMT ++ ???
    %% Chantal Keller: Using several SMT in Coq?
