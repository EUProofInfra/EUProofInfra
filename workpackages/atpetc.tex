...
\begin{wpdelivs}
  ...
  \begin{wpdeliv}[due=48,id=ATPtrace2,dissem=PU,nature=OTHER,lead=Lie,task=instrumenting]{Trace producing Automatic Theorem Prover, Satisfiability Modulo Theories solvers, and Coherent Logic Solver}\end{wpdeliv}
  ...
  \begin{wpdeliv}[due=48,id=Dedukti2ATP2,dissem=PU,nature=OTHER,lead=Sac,task=deduktitoatp]{Translator from expressive Dedukti statements into TPTP and SMT-LIB, application to large libraries}\end{wpdeliv}
