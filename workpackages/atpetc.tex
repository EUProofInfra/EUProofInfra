...
\item External preprocessing, add traces to the rewrite engine of
  Frama-C-WP used before sending goals to solvers
\item \dots
\end{itemize}
...
\begin{itemize}
\item Ekstrato (using proofs): using ATP to provide detailed ATP proofs
\item Why3: gather the proof from the called provers, add traces for the
  transformations send all to ekstrato
\end{itemize}
