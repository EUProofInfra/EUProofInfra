...
\begin{tasklist}
  \begin{task}[id=instrumenting,
      ...
      shorttitle=Instrumenting ATPs to produce traces,
      lead=Lie,
      LieRM=31,
      ImtRM=1,
      OcaRM=12,
...
\end{task}
  ...
  \begin{task}[id=tracetodedukti,
      ...
      shorttitle=Translate ATP traces into Dedukti,
      lead=Imt,
      LieRM=14,
      ImtRM=8,
      SacRM=2,
...
\end{task}
  ...
  \begin{task}[id=deduktitoatp,
      ...
      shorttitle=Translate Dedukti statements into ATPs inputs,
      lead=Oca,
      LieRM=9,
      SacRM=3,
      BelRM=3,
...
% \end{itemize}
  ...
  %%     shorttitle=Logipedia as a source of knowledge for ATP]
  ...
  \begin{task}[id=readiness,
      ...
      shorttitle=ATPs to increase Logipedia readiness,
      lead=Inn,
      SacRM=4,
      InnRM=6,
      BelRM=3,
...
\begin{task}[id=cooperation,
    ...
    shorttitle=Logipedia and ATP end-to-end,
    lead=Cea,
    CeaRM=18,
    wphases=13-48!.5
    ]
...
% \begin{tasklist}
%   \begin{task}[id=tools,title=Automatic Tools Exporting Proofs,shorttitle=Automatic Tools Exporting Proofs]
...
%   \begin{task}[id=challenges,title=Logipedia as a Source of Challenges for Automatic Reasoners,shorttitle=Logipedia as a Source of Challenges for Automatic Reasoners]
...
%     %% Josef Urban: TPTP
%   \end{task}
%   \begin{task}[id=commang,title=Cooperation of Reasoners via Dedukti/Logipedia,shorttitle=Cooperation of Reasoners via Dedukti/Logipedia]
...
%   \end{task}
%   \begin{task}[id=database,title=A Database of Theorems for Automatic Solvers,shorttitle=A Database of Theorems for Automatic Solvers]
...
\begin{wpdelivs}
  \begin{wpdeliv}[due=6,id=ATPtrace1,dissem=PU,nature=DEM,lead=Lie,task=instrumenting]
    {Prototypes of Trace producing Automatic Theorem Prover and Satisfiability Modulo Theories solver}
  \end{wpdeliv}

  \begin{wpdeliv}[due=18,id=Trace2Dedukti1,dissem=PU,nature=DEM,lead=Imt,task=tracetodedukti]
    {Prototype of a translator for some traces to Dedukti}
  \end{wpdeliv}

  \begin{wpdeliv}[due=24,id=Dedukti2ATP1,dissem=PU,nature=DEM,lead=Sac,task=deduktitoatp]
    {Prototype of a translator from Dedukti statements into TPTP and
      SMT-LIB, application to simple libraries}
  \end{wpdeliv}

  \begin{wpdeliv}[due=36,id=ReadinessCode,dissem=PU,nature=DEM,lead=Sac,task=readiness]
    {Tools based on ATPs to increase Logipedia Readiness}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,id=ATPtrace2,dissem=PU,nature=OTHER,lead=Lie,task=instrumenting]
    {Trace producing Automatic Theorem Prover, Satisfiability Modulo
      Theories solvers, and Coherent Logic Solver}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,id=Trace2Dedukti2,dissem=PU,nature=OTHER,lead=Imt,task=tracetodedukti]
    {Translate most traces to Dedukti}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,id=Dedukti2ATP2,dissem=PU,nature=OTHER,lead=Sac,task=deduktitoatp]
    {Translator from expressive Dedukti statements into TPTP and
      SMT-LIB, application to large libraries}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,id=ReadinessReport,dissem=PU,nature=R,lead=Inn,task=readiness]
    {Report on Proof Automation in Logipedia}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,id=Why3,dissem=PU,nature=DEM,lead=Cea,task=cooperation]
