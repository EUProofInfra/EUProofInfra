...
\end{task}
  ...
  \begin{task}[id=deduktitoatp,
    ...
    and~\taskref{atpetc}{tracetodedukti}.  It also relates to Work Package
    \WPref{reversemath}.
...
% \end{itemize}
  ...
  \begin{task}[id=readiness,
    ...
    This task depends on tasks~\taskref{atpetc}{instrumenting}, \taskref{atpetc}{tracetodedukti} and
