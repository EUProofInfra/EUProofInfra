...
\item Resources: 15 p.m engineer (Oca) + 36 p.m phd (Lie+Stu) + 3 p.m
  permanent (Bel)
\end{compactitem}
...
\item Resources: 15 p.m engineer (Oca) + 36 p.m phd (Imt) + 2 p.m
  permanent (Sac)
\end{compactitem}
...
\item Goal: TODO
\item Milestones: TODO
\item Resources: 3 p.m engineer (Oca) + 3 p.m permanent (Bel) + 3 p.m permanent (Sac)
\end{compactitem}
