...
Secondly, Tasks~\localtaskref{strrefonto}, \localtaskref{strontorepml}, and~\localtaskref{strsafeonto}\ednote{remove if canceled} built ontologies for describing libraries.
