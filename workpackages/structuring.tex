...
\begin{tasklist}
\begin{task}[id=strlibstructure,title=Library Structure,shorttitle=Library Structure,lead=Fau,FauRM=8, SacRM=6, wphases=1-28!.5]
...
\begin{task}[id=strdofimpl,title=Ontological Framework for Meta-Data,shorttitle=Ontological Framework for Meta-Data,lead=Sac,SacRM=24,wphases=1-24!1.0]
...
\begin{task}[id=strrefonto,title=Reference Ontology,shorttitle=Reference Ontology,lead=Sac,FauRM=6,SacRM=6,wphases=12-36!.5]
...
\begin{compactitem}
 ...
 \item Manually written ontologies or imports of existing ontologies for knowledge formalized in prover libraries, such as the Upper Library Ontology
...
\begin{task}[id=strontorepml,title=Ontological Representation of Formal Libraries,shorttitle=Ontological Representation of Formal Libraries,lead=Fau,FauRM=6,BolRM=4,SacRM=5,wphases=12-48!.5]
...
It will also build on the ontological export of ULO data developed for Isabelle and Coq.
...
% Moved to WP9
%\begin{task}[id=strontosearch,title=Ontological Search,shorttitle=Ontological Search,lead=Fau,FauRM=12,SacRM=6]
...
%\begin{task}[id=strformsearch,title=Formula-based Search,shorttitle=Formula-based Search,lead=Fau,BolRM=4,FauRM=12]
%Search based on formula structure using systems like MathWebSearch
%\end{task} 

% suggested for removal in budget arbitration meeting
%\begin{task}[id=strtext,title=Ontological Representation of Natural Language Articles,shorttitle=Ontological Representation of Natural Language Articles,lead=Inr,FauRM=6,InrRM=14]
...
\begin{wpdelivs}
  \begin{wpdeliv}[due=18,id=deliv-str-framework,dissem=PU,nature=R,lead=Sac,task=strlibstructure]{Language with primitives for representing metadata and theories}\end{wpdeliv}

  \begin{wpdeliv}[due=36,id=deliv-str-ontology,dissem=PU,nature=R,lead=Sac,task=strdofimpl]{Framework for metadata annotations}\end{wpdeliv}
  
  \begin{wpdeliv}[due=48,id=deliv-str-libraries,dissem=PU,nature=R,lead=Fau,task=strontorepml]{Representation of major libraries of proofs}\end{wpdeliv}
\end{wpdelivs}
