...
Firstly, \wpref{theories} pursues inegration through standardization on universal *low-level* representations.
...
The prover exports from \wpref{instrumentation} will be such that they produce both representations whenever possible.
