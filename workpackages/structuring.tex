...
Thirdly, Tasks~\localtaskref{strontosearch}, \localtaskref{strformsearch}, and \localtaskref{strtextsearch} leverage the above in order to provide scalable search services for the entire Logipedia knowledge base.
\end{wpdescription}
