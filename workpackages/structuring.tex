...
Thirdly, Tasks~\localtaskref{strontosearch}, \localtaskref{strformsearch}, and \localtaskref{strtextsearch} leverage 
technical and domain-specific \emph{access} the entire Logipedia knowledge base based on ontologies by scalable search services.
...
This will be closely tied to the work by M. Wenzel as sub-contractor of \site{Fau} for Isabelle, and C. Sacerdoti Coen at \site{Bol} for Coq in \WPref{libraries}.
\end{task} 
...
\begin{task}[id=strformsearch,title=Formula-based Search,lead=Fau,FauRM=12]
