...
\begin{wpdelivs}
  ...
  \begin{wpdeliv}[due=12,miles=isabelle,id=isabelle,dissem=PU,nature=OTHER,lead=Tum]{Robust export of proof terms for Isabelle}
  \end{wpdeliv}

  \begin{wpdeliv}[due=12,id=isabelleImproved,dissem=PU,nature=OTHER,lead=Tum]{Improved memory management and monitoring for Poly/ML}
  \end{wpdeliv}

  \begin{wpdeliv}[due=16,miles=hol4,id=hol4,dissem=PU,nature=OTHER,lead=Cha]{Export of proof terms for HOL4}
  \end{wpdeliv}

  \begin{wpdeliv}[due=18,id=agda,dissem=PU,nature=OTHER,lead=Del]{Export Agda's standard library to Dedukti}
  \end{wpdeliv}

  \begin{wpdeliv}[due=8,miles=coq,id=coq1,dissem=PU,nature=OTHER,lead=Inr]{Export of proof terms from Coq, no meta data}
  \end{wpdeliv}
  ...
  \begin{wpdeliv}[due=24,id=atelier-b1,dissem=PU,nature=DEM,lead=Cle]{A prototype of a tool exporting proof terms from Atelier B}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,id=atelier-b2,dissem=PU,nature=OTHER,lead=Cle]{Harness in Atelier B to export proof terms and import lemmas from Logipedia}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,id=atelier-b3,dissem=PU,nature=OTHER,lead=Tou]{Export/Import of B/Event B models from/in Rodin}
  \end{wpdeliv}
