...
\begin{wpdelivs}
  ...
  \end{wpdeliv}
  \begin{wpdeliv}[due=24,miles=logipedia-v1,id=atelier-b,dissem=PU,nature=DEM,lead=Cle]
    {a prototype of a tool exporting proof terms from Atelier B}
 \begin{wpdeliv}[due=48,miles=logipedia-v1,id=atelier-b,dissem=PU,nature=DEM,lead=Cle]
    {Harness in Atelier B to export proof terms and import lemmas from Logipedia}
\begin{wpdeliv}[due=48,miles=logipedia-v1,id=atelier-b,dissem=PU,nature=DEM,lead=INPT]
    {Export/Import of B/Event B models from/in  Rodin}
\end{wpdelivs}
\end{workpackage}
