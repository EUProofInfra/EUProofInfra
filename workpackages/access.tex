...
\begin{wpdelivs}
  ...
  \begin{wpdeliv}[due=14,miles=platform,id=website,dissem=PU,nature=DEM,lead=Irt]{Logipedia website}
    Prototype version of the Logipedia platform
  \end{wpdeliv}

  \begin{wpdeliv}[due=27,id=website,dissem=PU,nature=OTHER,lead=Irt]{Logipedia website}
