...
% OTHER: Software, technical diagram, etc.
  ...
  \begin{wpdeliv}[due=24,id=industrial-club-report1,dissem=PU,nature=R,lead=Irt]{Midway report on industrial club}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,id=industrial-club-report2,dissem=PU,nature=R,lead=Irt]{Final report on industrial club}
  \end{wpdeliv}
