...
\begin{tasklist}
  ...
  \begin{task}[id=training,
      ...
      lead=Bir,BirRM=2,IrtRM=2,wphases=1-48!.05]
...
%     \end{itemize}
  ...
  \begin{task}[id=industrial-club,
    ...
    \item Encourage cooperation between companies around Logipedia. For example, by sharing rules and proofs between companies using the B method.
    \end{compactitem}
  \end{task}
...
experts. The task here is to evaluate the interest of Logipedia to address
...
% OTHER: Software, technical diagram, etc.
  ...
  \begin{wpdeliv}[due=1,miles=???,id=website-setting,dissem=PU,nature=DEC,lead=Inr]{Setting up project website}
  \end{wpdeliv}

  \begin{wpdeliv}[due=12,miles=???,id=website-enriched,dissem=PU,nature=DEC,lead=Inr]{Enrich project website}
  \end{wpdeliv}

  % deliverables for T2 training (Benedikt Ahrens, Birmingham, with the help of IRT SystemX for training targeting engineers)

  \begin{wpdeliv}[due=24,miles=???,id=training-report1,dissem=PU,nature=R,lead=Bir]{Midway report on training}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,miles=???,id=training-report2,dissem=PU,nature=R,lead=Bir]{Final report on training}
  \end{wpdeliv}

  % deliverables for T3 researchers club (Benedikt Ahrens, Birmingham)

  \begin{wpdeliv}[due=24,miles=???,id=researchers-club-report1,dissem=PU,nature=R,lead=Bir]{Midway report on researchers club}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,miles=???,id=researchers-club-report2,dissem=PU,nature=R,lead=Bir]{Final report on researchers club}
  \end{wpdeliv}

  % deliverables for T4 industrial club (IRT System X)

  \begin{wpdeliv}[due=24,miles=???,id=industrial-club-report1,dissem=PU,nature=R,lead=Irt]{Midway report on industrial club}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,miles=???,id=industrial-club-report2,dissem=PU,nature=R,lead=Irt]{Final report on industrial club}
  \end{wpdeliv}

  % deliverables for T5 certification authorities (Catherine Dubois, IMT)

  \begin{wpdeliv}[due=24,miles=???,id=certifiers-club-report1,dissem=PU,nature=R,lead=Imt]{Midway report on certification bodies}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,miles=???,id=certifiers-club-report2,dissem=PU,nature=R,lead=Imt]{Final report on certification bodies}
  \end{wpdeliv}

  % deliverables for T6 teachers club (Julien Narboux, Unistra)

  \begin{wpdeliv}[due=24,miles=???,id=teachers-club-report1,dissem=PU,nature=R,lead=Str]{Midway report of the teachers club}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,miles=???,id=teachers-club-report2,dissem=PU,nature=R,lead=Str]{Final report of the teachers club}
  \end{wpdeliv}

  % deliverables for T7 publishers club (Wolfgang Dalitz, ZIB)

  \begin{wpdeliv}[due=24,miles=???,id=publishers-club-report1,dissem=PU,nature=R,lead=Zib]{Midway report on publishers club}
  \end{wpdeliv}

  \begin{wpdeliv}[due=48,miles=???,id=publishers-club-report2,dissem=PU,nature=R,lead=Zib]{Final report on the publishers club}
  \end{wpdeliv}

  % deliverables for T8 linking scientific publications to Logipedia (Wolfgang Dalitz, ZIB)

  \begin{wpdeliv}[due=24,miles=???,id=publish-links,dissem=PU,nature=OTHER,lead=Zib]{Database and search engine for linking Logipedia formal proofs with scientific publications}
  \end{wpdeliv}

  % deliverables for T9 web interface for education (Benoit Rognier, Edukera)

  \begin{wpdeliv}[due=24,miles=???,id=edu-display,dissem=PU,nature=DEM,lead=Edu]{Display Logipedia proofs}
  \end{wpdeliv}

  \begin{wpdeliv}[due=24,miles=???,id=edu-app,dissem=PU,nature=OTHER,lead=Edu]{Application for education}
  \end{wpdeliv}
