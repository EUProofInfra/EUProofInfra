...
% OTHER: Software, technical diagram, etc.
  ...
  \begin{wpdeliv}[due=24,miles=???,id=publish-links,dissem=PU,nature=OTHER,lead=Edu]{Database and search engine for linking Logipedia formal proofs with scientific publications}

  % deliverables for T9 web interface for education (Benoit Rognier, Edukera)

  \begin{wpdeliv}[due=36,miles=???,id=edu-display,dissem=PU,nature=DEM,lead=Edu]{Display Logipedia proofs}
  \end{wpdeliv}

  \begin{wpdeliv}[due=36,miles=???,id=edu-app,dissem=PU,nature=OTHER,lead=Edu]{Application for education}
  \end{wpdeliv}
