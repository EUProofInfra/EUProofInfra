...
200.000 lines of definitions and proofs, correspondig to almost 4000 printed
...
mathematics. Moreover, it is the only exising library in this area where
...
and mathematical finance. The purpose of this task is to struture, document
...
Dedukti level.  This is where we need to interface with \WPref{theories}. We
...
correspond to proper methemtical theorems as opposed to auxiliary lemmas
...
Integrals, ODEs, Types-To-Sets, Probablity
\end{task}
