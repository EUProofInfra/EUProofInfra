...
The {HOL Light} library is large and varied.
...
The {Flyspeck} project gives a formal proof of the {Kepler}
conjecture. The statement and proof is based on an original proof of Thomas
{Hales} \cite{DBLP:journals/corr/HalesABDHHKMMNNNOPRSTTTUVZ15},
and formalized and proved largely in {HOL Light}\footnote{\url{https://github.com/flyspeck/flyspeck}}.
The richness of this library, with some results not formalized in any
other system, motivates the project of importing the {HOL Light}
library and {Flyspeck} project in the {Dedukti} system, in view
of its integration into {Logipedia}.
