...
%\begin{task}[id=milc,title=Revised Coq Analysis Library,shorttitle=Revised Coq Analysis Library]
%\ednote{Saclay (Boldo), Paris, Sophia}
%\end{task}

%\begin{task}[id=mizar,title=The Mizar library,shorttitle=The Mizar library]
...
\begin{task}[
  ...
  shorttitle=Isabelle's Archive of Formal Proofs,
  lead=Tum,
  TumRM=3,
  wphases=13-18]
%\ednote{Wenzel}
...
\begin{task}[
  ...
  shorttitle=The Isabelle Analysis \& Probability Theory library,
  lead=Tum,
  TumRM=24,
  wphases=1-24]
%
...
\begin{task}[
  ...
  shorttitle=The Flyspeck library,
  lead=Inr,
  wphases=1-36]
...
\begin{task}[
  ...
  shorttitle=The CakeML compiler library,
  lead=Cha,
  ChaRM=12,
  wphases=12-23]
%
...
%\begin{task}[id=unimath,title=The UniMath library,shorttitle=The UniMath library]
%\ednote{Birmingham (Ahrens)}
%\end{task}

%\begin{task}[id=pvs,title=The NASA PVS library,shorttitle=The NASA PVS library]
%\end{task}
%\begin{task}[id=sel4,title=The seL4 library,shorttitle=The seL4 library]
%\end{task}

%\begin{task}[id=compcert,title=The CompCert library,shorttitle=The CompCert library]
%\end{task}
\end{tasklist}

\begin{wpdelivs}
  \begin{wpdeliv}[due=36,id=exportafp,dissem=PU,nature=DEM,lead=Tum,task=afp]
      {Scalable export of proof terms for major parts of Isabelle/AFP}
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,id=exportanalysis,dissem=PU,nature=DEM,lead=Tum,task=isaAnalysisProb]
      {Export of Isabelle's extended analysis and probability theory library}
  \end{wpdeliv}
  \begin{wpdeliv}[due=18,id=geocoq-import,dissem=PU,nature=OTH,lead=Str,task=geocoq]
      {Export of most of GeoCoq library}
  \end{wpdeliv}
  \begin{wpdeliv}[due=36,id=flyspec,dissem=PU,nature=OTH,lead=Inr,task=flyspeck]
      {Export some reusable parts of the multivariate analysis library from the Flyspeck library}
  \end{wpdeliv}
  \begin{wpdeliv}[due=26,id=cakeml,dissem=PU,nature=DEM,lead=Cha,task=cakeml]
