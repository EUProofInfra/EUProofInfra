...
\makeatletter
\newcounter{month}
%\def\offset@reset{\setcounter{month}{0}\@whilenum\value{month}<\numexpr\pdataref@aux{prop}{gen}{months}+1\do{\expandafter\edef\csname offset\the\value{month}\endcsname{2}\stepcounter{month}}}
%\def\offset@incr#1{\expandafter\edef\csname offset#1\endcsname{\the\numexpr\csname offset#1\endcsname+10}}
%\def\offset@get#1{\csname offset#1\endcsname pt}
...
\pgfsetlayers{background,miles,main,delivs}
...
\ganttmilestone[inline,milestone inline label node/.append style={anchor=south}]{\pdataRef{deliv}{\@deliv}{label}}{\pdataref@num{deliv}{\@deliv}{due}}
\else
...
\offset@incr{\pdataref@num{deliv}{\@deliv}{due}}
\fi
}
\end{pgfonlayer}
\\
...
\offset@incr{\pdataref@num{mile}{\@mile}{month}}
}
\end{pgfonlayer}
\end{ganttchart}
\caption{Gantt chart}
