...
\multicolumn{2}{|l|}{
  ...
  École polytechnique, Mines ParisTech, Université de Lorraine.

  Three researchers from École polytechnique,}\\
\multicolumn{2}{|l|}{
  Mines ParisTech, and Université
  de Lorraine have had long term cooperation with the Inria group.}
\\
\hline
