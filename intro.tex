...
Our societies depend more and more on digital infrastructures.  This
dependency is made extremely visible in times of a crisis, when
teleworking, telemedecine, distance learning, etc. are at the center
of their resilience.  In such situations, as well as in more common
ones, the safety of software is the basis of the reliability of these
infrastructure and the solidity of our societies: a single bug can
cause people to die and enterprises to go bankrupt.
...
formal proofs, that guarantee the safety of people using
transportation systems (autonomous cars, subways, trains, planes,
etc.), health systems (robotic surgery, ear implants, etc.), energy
provided by nuclear plants, financial applications, e-governance, etc.
...
\cite{Behm98,Lecomte17}, the detect-and-avoid system for unmanned
...
has been empirically observed that operating systems and compilers
often have bugs, but proved systems and compilers, such as seL4 or
CompCert, have none, or much fewer.  This is why, at the highest
Evaluation Assurance Levels (EAL) of the Common Criteria (CC) security
evaluation international standard, in effect since 1999, certification
processes require proofs, and not only testing.
...
competitive advantage to European companies and Europe as a while.

Aside from their use in software verification, proofs have also always been the basis of mathematics, and hence of
many mathematised sciences. In this area, the use of formal proofs has made significant progress,
as witnessed by the formalisation of the Feit-Thompson theorem \cite{Gonthier13}. 
This is important since the correctness of proofs is sometimes  hard to establish,
because of their length and complexity, as in the case of Hales' theorem (Kepler's conjecture), which has now been formally verified \cite{Hales17} ({cf.}~also the recent controversy on the $abc$ conjecture). 
Thus, formal proofs have a wide range of applications, from safety and security of software to mathematics.
...
study particles. Figure \ref{systems} lists the most prominent proof systems today.
