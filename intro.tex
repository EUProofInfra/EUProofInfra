...
observe in times of a crisis, when teleworking, telemedecine, distance
learning, etc. are at the center of their resilience.  In such
situations, as well as in more common ones, the solidity of our
societies depends on the reliability of these infrastructure: a single
bug can cause people to die and enterprises to go bankrupt.
...
Feit-Thompson theorem \cite{Gonthier13}.  Such a used of formal proofs
